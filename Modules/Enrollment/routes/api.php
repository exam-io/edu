...
Route::middleware(['tenant', 'tenant.context', 'tenant.active', 'tenant.scope', 'auth:sanctum'])->group(function (): void {
    ...
    Route::get('teacher-assignments', [TeacherAssignmentController::class, 'index'])->middleware('identity.permission:teacher_assignment.view');
    Route::post('teacher-assignments', [TeacherAssignmentController::class, 'store'])->middleware('identity.permission:teacher_assignment.create');
    Route::get('teacher-assignments/{id}', [TeacherAssignmentController::class, 'show'])->middleware('identity.permission:teacher_assignment.view');
    Route::put('teacher-assignments/{id}', [TeacherAssignmentController::class, 'update'])->middleware('identity.permission:teacher_assignment.update');
    Route::delete('teacher-assignments/{id}', [TeacherAssignmentController::class, 'destroy'])->middleware('identity.permission:teacher_assignment.delete');
});
